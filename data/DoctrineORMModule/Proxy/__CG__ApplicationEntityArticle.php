...
class Article extends \Application\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'csrf', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'title', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'description', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'ingredient', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'instruction', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'category', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'isPublic', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'articleLike', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'articleDislike', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'image', '' . "\0" . 'Application\\Entity\\Article' . "\0" . 'submit'];
        }
